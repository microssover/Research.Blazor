...
namespace Research.Infrastructure.Migrations
{
    ...
    [Migration("20241204122612_FlowIdToJobTypes")]
    partial class FlowIdToJobTypes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Research.Entity.Models.JobType", b =>
                {
                    ...
                    b.HasOne("Research.Entity.Models.ApplicantFlow", "ApplicantFlow")
                        .WithMany("JobTypes")
                        .HasForeignKey("FLOW_ID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.Navigation("ApplicantFlow");
